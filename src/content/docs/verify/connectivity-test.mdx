...
<Aside type="danger">
These files contain secrets. They are listed in `.gitignore` (`demo-gce-key`, `demo-gce-key.pub`) — do not commit them. Remove them during [Teardown](/aws-gcp-interconnect-walkthrough/teardown/).
</Aside>
