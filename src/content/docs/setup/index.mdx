...
1. [Configure variables](/setup/configure-variables/) — edit `terraform.tfvars` with your project details
2. [Apply Terraform](/setup/apply-terraform/) — create the base infrastructure
3. [GCP prep](/setup/gcp-prep/) — enable the Network Connectivity API and service agent
